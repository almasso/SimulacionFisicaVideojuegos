...
private:
	int gen;
public:
	Firework(int gen, Vector3 Pos, Vector3 Vel, float damping = 0.998, Vector4 Col = { 1,0,0,1 }, bool affectedByGravity = false) : Particle(Particle_Type::FIREWORK, 1.0, Pos, Vel, damping, Col), gen(gen) {}
