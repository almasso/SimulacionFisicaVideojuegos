...
Particle::Particle(Vector3 pos, Vector3 vel, Vector3 acceleration, float damping, Vector4 Col) : acceleration(acceleration), vel(vel), pose(physx::PxTransform(pos)), damping(damping) {
